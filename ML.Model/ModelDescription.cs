...
namespace ML.Model
{
    public class ModelDescription : IModelDescription
    {
        public string GetDescription(string algorithmName)
        {
            ...
            {
                "Logistic regression" =>"Logistic regression is an algorithm for binary \n" +
                                        "classification. \n\n" +
                ...
                "Averaged Perceptron" => "Averaged Perceptron is an algorithm for binary \n" +
                                        "classification. \n\n" +
                    ...
                    "Decision tree" =>  "A decision tree is an algorithm for text classification. \n\n" +
            ...
            "Naive Bayes classifier" => "Naive Bayes is an algorithm for text classification. \n\n" +
